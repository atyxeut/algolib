#ifndef AAL_SRC_LIB_MATH_INTEGRAL_BASIC_OPERATION_IS_PALINDROME_HPP
#define AAL_SRC_LIB_MATH_INTEGRAL_BASIC_OPERATION_IS_PALINDROME_HPP
...
#endif // AAL_SRC_LIB_MATH_INTEGRAL_BASIC_OPERATION_IS_PALINDROME_HPP
