#ifndef AAL_SRC_LIB_IO_RANGE_OUT_HPP
#define AAL_SRC_LIB_IO_RANGE_OUT_HPP

/* https://github.com/atyxeut/algolib/blob/cpp23/src/lib/io/range/out.hpp */
...
#include "../../../fundamental/type_trait/io.hpp"
...
auto& operator <<(std::basic_ostream<TChar>& ostr, TRange&& range)
{
  ::aal::print(
...
#endif // AAL_SRC_LIB_IO_RANGE_OUT_HPP
