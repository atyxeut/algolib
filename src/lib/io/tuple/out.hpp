#ifndef AAL_SRC_LIB_IO_TUPLE_OUT_HPP
#define AAL_SRC_LIB_IO_TUPLE_OUT_HPP

/* https://github.com/atyxeut/algolib/blob/cpp23/src/lib/io/tuple/out.hpp */
...
auto& operator <<(std::basic_ostream<TChar>& ostr, const std::pair<T1, T2>& p)
{
...
auto& operator <<(std::basic_ostream<TChar>& ostr, const std::tuple<Ts...>& t)
{
  ::aal::print(ostr, t, std::basic_string<TChar>(1, static_cast<TChar>(' ')));
  return ostr;
}

#endif // AAL_SRC_LIB_IO_TUPLE_OUT_HPP
