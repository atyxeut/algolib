#ifndef AAL_SRC_FUNDAMENTAL_CONCEPT_OPERATOR_HPP
#define AAL_SRC_FUNDAMENTAL_CONCEPT_OPERATOR_HPP

/* https://github.com/atyxeut/algolib/blob/cpp23/src/fundamental/concept/operator.hpp */
...
#endif // AAL_SRC_FUNDAMENTAL_CONCEPT_OPERATOR_HPP
