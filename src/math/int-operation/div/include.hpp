#ifndef AAL_SRC_MATH_INT_OPERATION_DIV_INCLUDE_HPP
#define AAL_SRC_MATH_INT_OPERATION_DIV_INCLUDE_HPP

/* https://github.com/atyxeut/algolib/blob/cpp20/src/math/int-operation/div/include.hpp */
...
#endif // AAL_SRC_MATH_INT_OPERATION_DIV_INCLUDE_HPP
