#ifndef AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_DIV_DETAIL_HPP
#define AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_DIV_DETAIL_HPP
...
#endif // AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_DIV_DETAIL_HPP
