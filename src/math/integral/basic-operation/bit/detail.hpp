#ifndef AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_BIT_DETAIL_HPP
#define AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_BIT_DETAIL_HPP
...
#endif // AAL_SRC_MATH_INTEGRAL_BASIC_OPERATION_BIT_DETAIL_HPP
