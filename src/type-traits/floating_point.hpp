...
/* https://github.com/atyxeut/algolib/blob/cpp20/src/type-traits/floating_point.hpp */
...
using make_higher_precision = detail::make_higher_precision_selector<T>::type;
