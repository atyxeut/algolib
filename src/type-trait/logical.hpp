#ifndef AAL_SRC_TYPE_TRAIT_LOGICAL_HPP
#define AAL_SRC_TYPE_TRAIT_LOGICAL_HPP

/* https://github.com/atyxeut/algolib/blob/main/src/type-trait/logical.hpp */
...
#endif // AAL_SRC_TYPE_TRAIT_LOGICAL_HPP
