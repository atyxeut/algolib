...
#include "src/macro/warning.hpp"
#include "src/misc/md_array_vector.hpp"

#include "src/include/aliases.hpp"
#include "src/include/io.hpp"
#include "src/include/math.hpp"
...
int main()
{
  ...
  auto prime = aal::sieve::linear::base(10000).first;
  auto minp = aal::sieve::linear::base(10000).second;
  ...
  // std::cout << aal::gcd(-2147483647 - 1, -2147483647 - 1, -2147483647 - 1, -2147483647 - 1, -2147483647 - 1);
  std::cout << aal::lcm(13553, -1426, 35ull, 46462, 1) << "\n";
  std::cout << "----------------------\n";

  std::cout << aal::idiv::floor(-2147483647 - 1, 1) << "\n";
